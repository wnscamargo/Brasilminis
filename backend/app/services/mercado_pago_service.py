"""Mercado Pago via Orders API.

Access Token permanece somente no backend e cifrado.
Ambientes TESTE e PRODUÇÃO são isolados; PRODUÇÃO exige credenciais próprias,
teste de conexão bem-sucedido e confirmação explícita antes da ativação.
"""
import hashlib
import hmac
import logging
